...
7. Habitat system - after a slime hatches, you should have the option to click on a habitat, and place the slime inside an habitat, only 2 slimes per habitat, a slime can only go inside an habitat IF the the slime has an element that matches the element of a habitat