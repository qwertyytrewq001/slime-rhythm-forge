...
import { SHAPE_NAMES, EYE_NAMES, MOUTH_NAMES, SPIKE_NAMES, PATTERN_NAMES, GLOW_NAMES, AURA_NAMES, ACCESSORY_NAMES, COLOR_PALETTE, MODEL_NAMES, ELEMENT_NAMES, RARITY_TIER_COLORS, ELEMENT_MODEL_FEATURES } from '@/data/traitData';
    ...
    <div className="flex flex-col h-full bg-card/80 backdrop-blur-sm border-l-4 border-primary/20 p-3 overflow-y-auto"
      ...
      {slime ? (
        <div className="flex flex-col items-center gap-2">
          ...
          {/* Elements — comma-separated clean list */}
